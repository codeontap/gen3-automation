...
Go to Google console->Groups and select "Create Group" in the top right hand corner.
...
Click "Domains" under Verified Senders
...
Select the "Administrator Access" policy template
