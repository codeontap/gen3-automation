...
function main() {
    ...
    BLUEPRINT_CONSOLIDATION_BASE_DIR="${INFRADOCS_DIR:-${TENANT_INFRASTRUCTURE_DIR}}"
    ...
    BLUEPRINT_CONSOLIDATION_DIR="${BLUEPRINT_CONSOLIDATION_TEMP}/${BLUEPRINT_CONSOLIDATION_BASE_DIR}"
