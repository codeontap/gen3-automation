...
REGISTRY_PROVIDER=${PRODUCT_REGISTRY_PROVIDER}
...
REMOTE_REGISTRY_PROVIDER=${PRODUCT_REMOTE_REGISTRY_PROVIDER}
...
REGISTRY_PROVIDER="${REGISTRY_PROVIDER:-${PRODUCT_REGISTRY_PROVIDER}}"
...
REMOTE_REGISTRY_PROVIDER="${REMOTE_REGISTRY_PROVIDER:-${PRODUCT_REMOTE_REGISTRY_PROVIDER}}"
