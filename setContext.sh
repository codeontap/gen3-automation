...
if [[ -z "${ACCOUNT_CONFIG_REPO}" ]]; then
    ...
    ACCOUNT_CONFIG_REPO="$(basename ${!ACCOUNT_CONFIG_REPO_VAR:-$ACCOUNT-config})"
fi
if [[ -z "${ACCOUNT_INFRASTRUCTURE_REPO}" ]]; then
    ACCOUNT_INFRASTRUCTURE_REPO_VAR="${ACCOUNT_UPPER}_INFRASTRUCTURE_REPO"
    ACCOUNT_INFRASTRUCTURE_REPO="$(basename ${!ACCOUNT_INFRASTRUCTURE_REPO_VAR:-$ACCOUNT-infrastructure})"
fi
...
if [[ -z "${PRODUCT_INFRASTRUCTURE_REPO}" ]]; then
    ...
    PRODUCT_INFRASTRUCTURE_REPO="$(basename ${!PRODUCT_INFRASTRUCTURE_REPO_VAR:-$PRODUCT-infrastructure})"
fi
